...
#%%
filename='TWA_2021-04-26_15-03-01_UTC_F55,500000M'
tdms_filename = 'data/2021-04-26_RF_Commissioning/'+filename+'.tdms'
...
with plt.style.context('seaborn'):
    ...
    fig.savefig('TWAmockup_500kW-60s.png', dpi=150)