...
data.df.plot(y='TOS', ax=ax[1], label='RL')
...
data.df.plot(y='Pm2', ax=ax[5])
data.df.plot(y='Pm3', ax=ax[5])
data.df.plot(y='Pm4', ax=ax[5])
data.df.plot(y='Pm5', ax=ax[5])
data.df.plot(y='Pm6', ax=ax[5])
